							...
							<div className='py-8 space-y-4 text-base leading-6 text-gray-700 sm:text-lg sm:leading-7'>
								...
								<ul className='space-y-2 list-disc'>
									<li className='flex items-start'>
										...
										<p className='ml-2'>
											Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam asperiores exercitationem, ipsa cum ipsum
											quod dolore ducimus excepturi maiores accusantium!
										</p>
									</li>
									<li className='flex items-start'>
										<span className='flex items-center h-6 sm:h-7'>
