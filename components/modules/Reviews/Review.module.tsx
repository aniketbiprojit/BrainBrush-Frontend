const Review = (props) => {
	return (
		<div
			className='grid grid-cols-2 grid-rows-5 gap-5 p-10 mx-5 mb-10 text-center duration-300 bg-white shadow-2xl w-400px lg:transform hover:-translate-y-8 lg:mb-0 align-items-center rounded-2xl'
			id='review-card'
		>
