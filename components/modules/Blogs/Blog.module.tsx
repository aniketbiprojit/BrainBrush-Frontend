const Blog = (props) => {
	return (
		<div
			className='grid grid-cols-2 grid-rows-6 p-10 mx-10 my-5 duration-200 bg-white border-2 border-gray-400 shadow-2xl align-items-center rounded-2xl'
			id='blog-card'
		>
			...
			<div className='col-span-2 row-span-4 m-auto text-sm text-justify text-gray-700 lg:text-lg justify-self-start'>{props.msg}</div>
