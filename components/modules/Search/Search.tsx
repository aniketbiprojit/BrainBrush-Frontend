...
const Search = (props) => {
	const styles = {
		container: 'flex flex-col items-center w-screen pt-72 bg-gradient-to-tr from-secondary to-secondary-light',
	...
	return (
		<div className={styles.container} id='nav'>
			...
			<svg className='relative w-screen transform translate-y-1' viewBox='0 0 3108 1159' fill='none'>
				<path
