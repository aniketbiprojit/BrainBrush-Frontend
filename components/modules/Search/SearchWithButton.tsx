...
const SearchWithButton = (props) => {
	const styles = {
		...
		button: 'px-4 py-3 border-solid border-black rounded-md text-white bg-secondary-light outline-none red-button rounded-l-none',
		head: 'text-primary text-center text-lg md:text-3xl font-bold pb-4',
	}

	if (props.color === 'black') {
		styles.head = 'text-gray-900 text-center text-lg md:text-3xl font-bold pb-4'
	}
