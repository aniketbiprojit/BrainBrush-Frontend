...
const Footer = (props: any) => {
	...
	const styles = {
		...
		container: 'bg-primary flex flex-col md:flex-row text-left justify-evenly px-14 py-20',
		menu: {
			header: 'font-bold text-lg p-2 py-8 text-white flex flex-row',
		...
		search: {
			...
			header: 'text-xl font-semibold pt-4 text-white',
