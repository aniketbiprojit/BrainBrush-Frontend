...
const Footer = (props: any) => {
	...
	const styles = {
		...
		container: 'bg-primary flex flex-col md:flex-row text-left justify-evenly px-14 py-36',
		menu: {
		...
		copyContainer: 'bg-primary flex text-left justify-evenly p-16 border-t border-gray-600',
