	...
	return (
		<div className={classes.root}>
			<Grid container spacing={3}>
				<Grid item xs={9}>
					<Grid item xs={12}>
						<Intro data={introdata} header={`${company} Revenue Per Employee`} />
					</Grid>
					<Grid item xs={12}>
						<BarChartRevenue annual={annualData} quarterly={quarterlyData} header={`${company} Revenue Per Employee`} />
					</Grid>
					<Grid item xs={12}>
						<Content header={`${company} Revenue Per Employee - Year over Year (Y/Y) Growth`} />
					</Grid>
					<Grid item xs={12}>
						<PieChartRevenue
							annual={pieannualData}
							quarterly={piequarterlyData}
							header={`${company} Revenue Per Employee - Year over Year (Y/Y) Growth`}
						/>
					</Grid>
					<Grid item xs={12}>
						<Table annual={annualtabledata} quarterly={quarterlytabledata} header={`${company} Revenue Per Employee (Tabular)`} />
					</Grid>
				</Grid>
				<Grid item xs={3}>
...
export default RevenueEmployeesLayout
